...
export default function Programmers() {
  ...
  const foundDev = programmers.find(dev => dev.id === featured)  // step 5
   return foundDev.name;
  }
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: featured ? 'gold' : 'royalblue', // 🤔 color turns to gold, when celebrating // Step 2
  };
